            ...
            <form method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        ...
                        <input type="text" name="admission_date" class="form-control date-picker"
                            value="@if ($is_update) {{ $student?->admission_date }}@else{{ old('admission_date') }} @endif">
                    </div>
                    <div class="col-md-4 mt-2">
                        <label>Due Date *</label>
                        <input type="text" name="due_date" class="form-control date-picker"
                    ...
                    <div class="row mt-2">
                        <div class="col-md-1">
                            ...
                            @if($is_update)
                                ...
                                @if($is_update && $student->enrolledCourses->contains('course_id', $course->id))
                        ...
                        <div class="col-md-3">
                            <input type="text" name="courses[{{ $course->id }}][paid_amount]" placeholder="Paid"
                                class="form-control" @if($is_update && $student->enrolledCourses->contains('course_id', $course->id))
                                value="{{ $student->enrolledCourses->where('course_id', $course->id)->first()->paid_amount }}" @else value="{{ old('paid_amount') }}@endif">
                        </div>
                    </div>
                @endforeach
